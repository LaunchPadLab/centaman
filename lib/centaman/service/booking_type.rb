module Centaman
  class Service::BookingType < Centaman::Service
    ...
    def build_objects(resp)
      # TODO keep or remove booking type mappings? currently overwritign service.rb build_objects method to create them
      raise 'FIX ME'
    ...
    def create_mappings(resp)
      # TODO may need to remove if not keeping mappings
      raise 'FIX ME'
